  ...
  <main id="main">
    <div class="h-[200px] flex justify-center items-center">
      <div class="text-white">
        ...
        >
          Here are some resources that I've created to help developers.
        </p>
      </div>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-1 gap-4 text-white py-4 max-w-md mx-auto px-8">
      <a href="https://sowl.co/6kgED">
        <div class="bg-[#1e1e1e] rounded p-10">
          <h1 class="text-2xl font-bold mb-2">VSCode Settings</h1>
          <p class="text-[#a5a5a5]">
            Access my VSCode settings and extensions. I've spent a lot of time
            customizing my VSCode to be as productive and minimalist as possible.
          </p>
          <button
          ...
          >
            ...
            <span>Click here to get access to it</span>
          </button>
        </div>
      </a>
