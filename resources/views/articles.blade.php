<x-guest-layout>
      ...
      <div>
        @if (Route::has('login'))
          <div class="p-6 flex z-10">
              ...
              @else
                  {{-- <a href="{{ route('login') }}" class="flex font-semibold text-gray-600 hover:text-gray-900 dark:text-white dark:hover:text-c focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
  ...
  <main id="main">
    <div class="h-[200px] flex justify-center items-center">
      <div class="text-white">
        ...
        >
          I write about AI, Laravel, Tailwind, Livewire, and other web development
          topics.
        </p>
      </div>
    </div>
    <div class="grid grid-cols-1 gap-4 text-white py-8 max-w-7xl mx-auto px-8">
      <div class="bg-[#1e1e1e] rounded p-12">
        ...
        <p class="text-[#a5a5a5]">
          ...
          Developing an ERP system to manage the company's operations, replacing a legacy system, originally initiated in the late 1990s using Microsoft Access 2000. The system is being developed using Laravel, Tailwind, and Livewire.
        </p>
      </div>
      ...
      <div class="bg-[#1e1e1e] rounded p-12">
        ...
        <button class="bg-[#272727] px-4 py-2 rounded mt-8 flex items-center">
          <span class="relative flex h-3 w-3 mr-4">
            <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#D7EF55] opacity-75"></span>
            <span class="relative inline-flex rounded-full h-3 w-3 bg-[#D7EF55]"></span>
          </span>
  ...
  <footer class="fixed bottom-0 w-full bg-[#131313] border border-b-1 border-[#1E1E1E] py-8 text-[#6B6B6B] px-8">
