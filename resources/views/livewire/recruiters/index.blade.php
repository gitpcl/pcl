...
<div>
    <div class="p-6 lg:p-8 bg-[#1E1E1E] border-b border-[#1E1E1E]">
        <div class="px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                <input class="rounded border-none bg-[#1e1e1e] text-white placeholder-[#484848] focus:outline-none focus:border-[#D7EF55] transition" type="text" wire:model="search" placeholder="Search emails...">
            </div>
